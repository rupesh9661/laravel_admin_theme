"use strict!";function handlemenutype(e){$(".pcoded").attr("nav-type",e)}$(document).ready(function () {
    $("#pcoded").pcodedmenu({
        ...
        (function () {
            $(".theme-color > a.header-theme-full").on("click", function () {
                ...
                $(".pcoded-header").attr("header-theme", e),
                    $(".navbar-logo").attr("logo-theme", e),
                    $(".pcoded-navbar").attr("active-item-theme", t),
                    $(".pcoded").attr("fream-type", e),
        ...
        (function () {
            $("#vertical-menu-effect")
                .val("shrink")
                .on("change", function (e) {
                    (e = $(this).val()),
                        $(".pcoded").attr("vertical-effect", e);
                });
        })(),
        (function () {
            $("#vertical-border-style")
                ...
                .on("change", function (e) {
                    (e = $(this).val()),
                        $(".pcoded-navbar .pcoded-item").attr(
                            "item-border-style",
                            e
                        );
                });
        ...
        (function () {
            $("#vertical-dropdown-icon")
                .val("style1")
                .on("change", function (e) {
                    (e = $(this).val()),
                        $(".pcoded-navbar .pcoded-hasmenu").attr(
                            "dropdown-icon",
                            e
                        );
                });
            ...
            $("#sidebar-position").change(function () {
                $(this).is(":checked")
                    ? ($(".pcoded-navbar").attr(
                      ...
                      $(".pcoded-header .pcoded-left-header").attr(
                          "pcoded-lheader-position",
                          "fixed"
                      ))
                    : ($(".pcoded-navbar").attr(
                          "pcoded-navbar-position",
