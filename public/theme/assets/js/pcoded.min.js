($.fn.pcodedmenu = function (e) {
    var t = this.attr("id"),
        ...
        o = {
            PcodedMenuInit: function () {
                o.Handlethemelayout(),
                    o.HandleverticalMenuplacement(),
                    o.HandlehorizontalMenuplacement(),
                    o.HandleMenulayout(),
                    o.HandleDeviceType(),
                    o.Handlecomponetheight(),
                    o.HandleMenuOnClick(),
                    o.HandleMenuTrigger(),
                    o.HandleSubMenuTrigger(),
                    o.HandleActiveItem(),
                    o.HandleOffcanvasMenu(),
                    o.HandleVerticalLeftHeader(),
                    o.HandleThemeBackground(),
                    o.HandleActiveItemStyle(),
                    o.HandleItemBorder(),
                    o.HandleBorderStyle(),
                    o.HandleSubItemBorder(),
                    o.HandleDropDownIconStyle(),
                    o.HandleOptionSelectorPanel(),
                    o.HandleNavbarPosition(),
                    o.HandleVerticalSubMenuItemIconStyle(),
                    o.HandleVerticalNavigationView(),
                    o.HandleHorizontalItemIsCentered(),
                    o.HandleHorizontalItemAlignment(),
                    o.HandleSubMenuOffset(),
                    o.HandleHorizontalStickyNavigation(),
                    o.HandleDocumentClickEvent(),
                    o.HandleVerticalScrollbar(),
                    o.HandleHorizontalMobileMenuToggle(),
                    o.horizontalNavigationMenuIcon(),
                    o.verticalNavigationSearchBar(),
                    o.safariBrowsercompatibility(),
                    o.Handlemenutype(),
                    o.Handlelayoutvartype();
            },
            ...
            HandleHorizontalMobileMenuToggle: function () {
                "horizontal" === e.themelayout &&
                    $("#mobile-collapse,#mobile-collapse1").on(
                        "click",
                        function () {
            ...
            HandleVerticalScrollbar: function () {
                "vertical" === e.themelayout &&
                    ((satnt = e.defaultVerticalMenu.desktop),
                    ("expanded" !== satnt && "compact" !== satnt) ||
                        ((mt = e.MenuTrigger),
                        "click" === mt &&
                ...
                !(function () {
                    ...
                    (function () {
                        $(document).on("click", function (e) {
                            var a = $(e.target),
                                o = $("#" + t + " .pcoded-search");
                            a.parents(".pcoded-search").length ||
                                o.removeClass("open");
                        });
                    })();
            },
            ...
            HandleHorizontalItemIsCentered: function () {
                if ("horizontal" === e.themelayout)
                    switch (e.horizontalNavIsCentered) {
                        case !0:
                            $("#" + t + " .pcoded-navbar").addClass(
                                "isCentered"
                            );
                            break;
                        case !1:
                            $("#" + t + " .pcoded-navbar").removeClass(
                                "isCentered"
                            );
                    }
            },
            HandleHorizontalItemAlignment: function () {
                "horizontal" === e.themelayout &&
                    !1 === e.horizontalNavIsCentered &&
                    ((function () {
                        var a = $(
                            "#" + t + ".pcoded .pcoded-navbar .pcoded-brand"
                        );
                        if (!0 === e.horizontalBrandItem)
                            switch (e.horizontalBrandItemAlign) {
                                case "left":
                                    a.removeClass("pcoded-right-align"),
                                        a.addClass("pcoded-left-align");
                                    break;
                                case "right":
                                    a.removeClass("pcoded-left-align"),
                                        a.addClass("pcoded-right-align");
                            }
                        else a.hide();
                    })(),
                    (function () {
                        var a = $(
                            "#" +
                                t +
                                ".pcoded .pcoded-navbar .pcoded-item.pcoded-left-item"
                        );
                        if (!0 === e.horizontalLeftNavItem)
                            switch (e.horizontalLeftNavItemAlign) {
                                case "left":
                                    a.removeClass("pcoded-right-align"),
                                        a.addClass("pcoded-left-align");
                                    break;
                    ...
                    (function () {
                        var a = $(
                            "#" +
                                t +
                                ".pcoded .pcoded-navbar .pcoded-item.pcoded-right-item"
                        );
                        if (!0 === e.horizontalRightItem)
                            switch (e.horizontalRightItemAlign) {
                                case "left":
                                    a.removeClass("pcoded-right-align"),
                                        a.addClass("pcoded-left-align");
                                    break;
                    ...
                    (function () {
                        ...
                        if (!0 === e.horizontalSearchItem)
                            switch (e.horizontalsearchItemAlign) {
                                case "left":
                                    a.removeClass("pcoded-right-align"),
                                        a.addClass("pcoded-left-align");
                                    break;
            ...
            HandleVerticalSubMenuItemIconStyle: function () {
                switch (e.themelayout) {
                    case "vertical":
                        ...
                        $("#" + t + " .pcoded-navbar .pcoded-hasmenu").attr(
                            "subitem-icon",
                            a
                        );
                        break;
            ...
            HandleNavbarPosition: function () {
                ...
                switch (e.themelayout) {
                    ...
                    case "horizontal":
                        1 == a
                            ? ($("#" + t + " .pcoded-navbar").attr(
                                  "pcoded-navbar-position",
                                  "fixed"
                              ),
                              $(
                                  "#" +
                              ...
                              ).attr("pcoded-lheader-position", "fixed"))
                            : ($("#" + t + " .pcoded-navbar").attr(
                                  "pcoded-navbar-position",
                                  "absolute"
                              ),
                              $(
                                  "#" +
                                      t +
                                      " .pcoded-header .pcoded-left-header"
                              ).attr("pcoded-lheader-position", "absolute")),
                            1 == o
                                ? ($("#" + t + " .pcoded-header").attr(
                                      "pcoded-header-position",
                                      "fixed"
                                  ),
                                  $("#" + t + " .pcoded-main-container").css(
                                      "margin-top",
                                      $(".pcoded-header").outerHeight()
                                  ))
                                : ($("#" + t + " .pcoded-header").attr(
                                      "pcoded-header-position",
                                      "relative"
            ...
            HandleSubItemBorder: function () {
                switch (e.SubItemBorder) {
                    case !0:
                        $("#" + t + " .pcoded-navbar .pcoded-item").attr(
                            "subitem-border",
                            "true"
                        );
                        break;
            ...
            Handlemenutype: function () {
                ...
                void 0 != a && "" != a
                    ...
                    void 0 != o && "" != o
                        ? $("#" + t).attr("fream-type", o)
                        : $("#" + t).attr("fream-type", "theme1");
            },
            Handlelayoutvartype: function () {
                var a = e.layouttype;
                void 0 != a && "" != a
                    ? $("#" + t).attr("layout-type", a)
                    : $("#" + t).attr("layout-type", "light");
            },
            HandleThemeBackground: function () {
                !(function () {
                    var t = e.ThemeBackgroundPattern;
                    void 0 != t && "" != t
                        ? $("body").attr("themebg-pattern", t)
                    ...
                    (function () {
                        ...
                        void 0 != a && "" != a
                            ? $("#" + t + " .pcoded-navigation-label").attr(
                                  "menu-title-theme",
                                  a
                              )
                            : $("#" + t + " .pcoded-navigation-label").attr(
            ...
            HandleVerticalLeftHeader: function () {
                ...
                switch (e.collapseVerticalLeftHeader) {
                    case !0:
                        $("#" + t + " .pcoded-header").addClass("iscollapsed"),
                            $("#" + t + " .pcoded-header").removeClass(
                                "nocollapsed"
                            ),
                            $("#" + t + ".pcoded").addClass("iscollapsed"),
                            $("#" + t + ".pcoded").removeClass("nocollapsed");
                        break;
                    case !1:
                        $("#" + t + " .pcoded-header").removeClass(
                            "iscollapsed"
                        ),
                            $("#" + t + " .pcoded-header").addClass(
                                "nocollapsed"
                            ),
                            $("#" + t + ".pcoded").removeClass("iscollapsed"),
                            $("#" + t + ".pcoded").addClass("nocollapsed");
                }
            },
            HandleOffcanvasMenu: function () {
                if ("vertical" === e.themelayout) {
                    "offcanvas" == $("#" + t).attr("vertical-nav-type") &&
            ...
            HandleSubMenuTrigger: function () {
                ...
                switch (e.SubMenuTrigger) {
                    case "hover":
                        $("#" + t + " .pcoded-navbar .pcoded-hasmenu").addClass(
                            "is-hover"
                        );
                        var o = $(window),
                            i = $(".pcoded-submenu > li"),
                        ...
                        a(d >= 992 ? "hover" : "click"),
                            o.resize(function () {
                                ...
                                d != e &&
                                    (e >= 992 && "hover" != n
                                        ? a("hover")
                                        : e < 992 && "click" != n && a("click"),
                                    (d = e));
                            });
                        break;
                    case "click":
                        $(
                            "#" + t + " .pcoded-navbar .pcoded-hasmenu"
            ...
            HandleMenuTrigger: function () {
                ...
                switch (e.MenuTrigger) {
                    case "hover":
                        ...
                        break;
                    case "click":
                        $("#" + t + " .pcoded-navbar").removeClass("is-hover"),
            ...
            HandleMenuOnClick: function () {
                ...
                "vertical" === e.themelayout
                    ? $(
                          "#mobile-collapse,#mobile-collapse1,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a"
                      ).on("click", function () {
                          $(this)
                              .parent()
                              .find(".menu-icon")
                          ...
                          if ("desktop" == a) {
                              ...
                              c == r
                                  ? $("#" + t).attr("vertical-nav-type", n)
                                  : d == o &&
                                    $("#" + t).attr("vertical-nav-type", r);
                          } else if ("phone" == a) {
                              var l = e.onToggleVerticalMenu.phone,
                                  s = e.defaultVerticalMenu.phone,
                                  p = $("#" + t).attr("vertical-nav-type");
                              p == s
                                  ? $("#" + t).attr("vertical-nav-type", l)
                                  : d == o &&
                                    $("#" + t).attr("vertical-nav-type", s);
                          }
            ...
            Handlecomponetheight: function () {
                function e() {
                    $(window).height(),
                        $(".pcoded-header").innerHeight(),
                        $(".pcoded-navbar").innerHeight(),
                        $(".pcoded-footer").innerHeight();
                }
                e(),
                ...
                function a() {
                    ...
                    if ("vertical" === e.themelayout)
                        if (a >= 768 && a <= 992) {
                            ...
                            void 0 != i && "" != o
                                ? $("#" + t).attr("vertical-effect", i)
                                : $("#" + t).attr("vertical-effect", "shrink");
                        } else if (a < 768) {
                            $("#" + t).attr("pcoded-device-type", "phone");
            ...
            HandlehorizontalMenuplacement: function () {
                if ("horizontal" === e.themelayout)
                    switch (e.horizontalMenuplacement) {
                        case "bottom":
            ...
            HandleverticalMenuplacement: function () {
                if ("vertical" === e.themelayout)
                    switch (e.verticalMenuplacement) {
                        case "left":
    ...
    $(window).scroll(function () {
        $(this).scrollTop() > 70
            ? ($(
                  '.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]'
              ).css("position", "fixed"),
              $(
                  '.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]'
              ).css("top", 0),
              ...
              $(
                  '.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"] .nav-list'
              ).css("height", "100%"))
            : ($(
                  '.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]'
    ...
    $(window).scroll(function () {
        $(this).scrollTop() > 70
            ? ($(
                  '.pcoded[theme-layout="horizontal"][pcoded-device-type="desktop"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]'
              ).css("position", "fixed"),
              $(
                  '.pcoded[theme-layout="horizontal"][pcoded-device-type="desktop"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]'
              ).css("top", 0))
    ...
    $(window).on("load", function () {
        $('.pcoded[vertical-nav-type="collapsed"] .pcoded-navbar').hover(
            function () {
