(function (element) {
    ...
    //  $('.statedropdown').change(get_district(this) );
    ...
    //             $.ajax({
    //                 type: "get",
    //                 url:  "https://synergy-test.msell.in/public/get_district",
    //                 dataType: 'json',
    //                 data: {'state_id': value},
    ...
    //                             var dropdown_start = `<label style="margin-bottom:0px"  for="parentClient" >District </label style= "margin-bottom:0px" >
    //                             <select class=' form-control fstdropdown-select' id="district_name" name="district_name" >`;   //changed district1 to district_name
    //                             var dropdown_option= ``;
    ...
    //                          document.getElementById("districtDropdownHere").innerHTML = dropdown_start+dropdown_option+dropdown_end;
