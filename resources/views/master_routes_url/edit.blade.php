    ...
    <div class="container-fluid bg-white mt-4 mb-3 border_radius box">
        <div class="row mt-4" >
            <div class="col-md-12 mt-4 mb-3">
                <form action="{{ route('master_routes_url.update' , $value->id) }}" method="POST">
                    @csrf
                    @method('patch')
                    <div class="container-fluid">
                        <div class="row first_row_margin">
                            <div class="col-md-6">
                                <h2 class="form-control-sm form_style yash_heading"><i
                                        class="fas fa-university mr-2"></i><b>Update Url Information</b></h2>
                            </div>
                        ...
                        <div class="form-row mt-3 mb-3 collapse show" id="collapseExample">
                            <div class="col-md-3 mb-3 ">
                                ...
                                <input type="text" name="url_name" value="{{$value->url_name}}" id="url_Name" class="form-control"
                                    required>
                            </div>
                            <div class="col-md-3 mb-3 ">
                                <label for="bank_Name" class="yash_star"
                                    style="margin-bottom:0px;">Url </label>
                                <input type="text" name="url" id="url_Name" value="{{$value->url}}" class="form-control"
                                     required>
                            </div>
                            {{-- <div class="col-md-3 mb-3 ">
