                ...
                <div class="row first_row_margin" style="margin-bottom: -12px;">
                    <div class="col-lg-12">
                        <div class="page-header-title">
                            ...
                            <h5>Complete list of Clients Added Between <span class="text-primary">{{!empty($one_week_before)?date('d-m-y' , strtotime($one_week_before)):''}}</span> And <span class="text-primary">{{date('d-m-y')}}</span></h5>
                                ...
                                <table id="table" data-toggle="table" data-search="true" data-filter-control="true"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="notess" data-sortable="true">Created On</th>
