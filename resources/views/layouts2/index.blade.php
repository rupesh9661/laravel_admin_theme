            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #4287BA;">
                <ul class="breadcrumb">
                    <li style="color: white">
                        ...
                        <a style="color: white" href="#">{{Lang::get('common.user')}} {{Lang::get('common.master')}}</a>
                    </li>

                    <li class="active" style="color: white">{{Lang::get('common.user_detail')}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
                ...
                <form class="form-horizontal open collapse in" action="" method="get" id="user-search" role="form"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-2">
                                ...
                                <select name="location_4[]" multiple id="location4" class="form-control chosen-select">
                                    <option value="">Select</option>
                                    @if(!empty($location_4))
                            ...
                            <div class="col-lg-2">  
                                ...
                                <select name="location_5[]" multiple id="location5" class="form-control chosen-select">
                                    <option value="">Select</option>
                                    @if(!empty($head_quater))
                                        @foreach($head_quater as $rk=>$rr)
                                            ...
                                            ?>
                                            <option @if(in_array($rk,$_GET['location_5'])){{"selected"}} @endif   value="{{$rk}}"> {{$rr}} 
                                            </option>                                                         
                                        @endforeach 
                                    @endif
                                </select>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-2">  
                                <label class="control-label no-padding-right" for="name">{{Lang::get('common.user')}} {{Lang::get('common.app_version')}}</label>
                      ...
                      {{--  <div class="col-lg-2">
                            ...
                            <div class="col-lg-2">
                                <a href="{{url($current_menu.'/create')}}" class=" input-sm form-control btn  btn-info" style="margin-top: 27px;">
                                    <i class="fa fa-plus mg-r-10"></i> {{Lang::get('common.add')}} {{Lang::get('common.user_detail')}}
                                </a>
                            </div>
                            ...
                            <div class="col-xs-12" style="overflow-x: scroll;">
                                ...
                                <table id="dynamic-table" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{Lang::get('common.user_name')}}</th>
                                        <th>{{Lang::get('common.password')}}</th>
                                        ...
                                        <th>{{Lang::get('common.last_sync_date')}}</th>
                                        <th>{{Lang::get('common.app_version')}}</th>
                                        <th>{{Lang::get('common.user_imei')}}</th>
                                        {{--<th>--}}
                                    ...
                                    @foreach($records as $key=>$data)
                                        ...
                                        <tr class="search_from_this">
                                            ...
                                            <td>{{!empty($location_4[$data->l4_name])?$location_4[$data->l4_name]:''}}</td>
                                            <td>{{!empty($location_5[$data->head_quater])?$location_5[$data->head_quater]:''}}</td>
                                            <td>{{!empty($location_6[$data->town_name])?$location_6[$data->town_name]:''}}</td>
                                            ...
                                            <td class="center">
                                                <div class="action-buttons">
                                                    <a href="#"  title="Show Details" user_id="{{ $data->id }}"  data-toggle="modal"  data-target="#user_assign_distributor" class="user_assign_distributor">
                                            ...
                                            <td> </td>
                                            @else
                                            <td>{{!empty($data->deactivate_date)?date("d-M-Y H:i:s", strtotime($data->deactivate_date)):'N/A'}}</td>
                                            @endif

                                            <td>{{!empty($data->last_sync)?date("d-M-Y H:i:s", strtotime($data->last_sync)):'N/A'}}</td>
                                            ...
                                            <td>
                                                ...
                                                <!-- for clear imei  -->
                                                    <a title="Clear Imei" class="btn btn-xs btn-danger" onclick="confirmAction('Clear IMEI','IMEI','{{$data->id}}','{{$status_table}}','clear');">
                                                        <i class="ace-icon fa fa-mobile-phone bigger-120"></i>
                                                    </a>
                                                    ...
                                                    <a title="Edit" class="btn btn-xs btn-primary" href="{{url($current_menu.'/'.$encid.'/edit')}}">
                                                    ...
                                                    <a title="Delete" user_id="{{ $data->id }}" role_id="{{ $data->role_id }}" data-toggle="modal"  data-target="#immediate_junior_list" class="btn btn-xs btn-danger immediate_junior_list">
                                                        <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                    </a>
                                                    ...
                                                    @endif --}}
                                                    <?php if($data->company_id == 61) { ?>    
                                                    @if($data->is_holiday_enabled==2)
                                                        <button class="btn btn-xs btn-info"
                                                                onclick="HolidayAction('{{"Holiday-Enable"}}','{{"Holiday-Enable"}}','{{$data->id}}','{{$table}}','Enable');" title="Click Here For Holiday Working Enable" >
                                                            <i class="ace-icon fa fa-toggle-off bigger-120"></i>
                                                        </button>
                                                    @else
                                                        <button class="btn btn-xs btn-success" 
                                                                onclick="HolidayAction('{{"Holiday-Enable"}}','{{"Holiday-Enable"}}','{{$data->id}}','{{$table}}','Disable');" title="Click Here For Holiday Working Disable">
                                                           <i class="ace-icon fa fa-toggle-on bigger-120"></i>
                                                    ...
                                                    <button title="Assign Distributor" userid="{{$data->id}}"
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title">User {{Lang::get('common.image')}}</h4>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">{{Lang::get('common.close')}}</button>
                                                    </div>
            ...
            <div class="modal-dialog modal-lg2">
                ...
                <div class="modal-content">
                    <div class="modal-header widget-header widget-header-small">
                        ...
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="smaller">{{Lang::get('common.assign')}} @Lang('common.dealer_module')</h4>
                        {{--</div>--}}
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header widget-header widget-header-small" >
                        ...
                        <h4 class="modal-title">{{Lang::get('common.location7')}} {{Lang::get('common.details')}}</h4>
                    ...
                    <div class="col-xs-12 col-md-10">
                        ...
                        <table class="table table-bordered table-hover" style="overflow-x: scroll;">
                            <thead class = "mythead_distibutor_list">
                                ...
                                <th>{{Lang::get('common.location7')}} Wise {{Lang::get('common.retailer')}} Count</th>
                                <th>{{Lang::get('common.action')}}</th>
                            </thead>
...
<div class="modal fade" id="junior_list_modal_on_modal" role="dialog">
    <div class="modal-dialog modal-lg3">
        ...
        <div class="modal-content">
            <div class="modal-header widget-header widget-header-small">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title smaller" > Junior {{Lang::get('common.details')}}</h4>
            </div>
            <div class="modal-body ui-dialog-content ui-widget-content">
                <div class="row">
...
<div class="modal fade" id="beat_modal_details" role="dialog">
    <div class="modal-dialog modal-lg3">
        ...
        <div class="modal-content">
            <div class="modal-header widget-header widget-header-small">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title smaller" > {{Lang::get('common.location7')}} {{Lang::get('common.details')}}</h4>
            </div>
            <div class="modal-body ui-dialog-content ui-widget-content">
                <div class="row">
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>
                    ...
                    success: function (data) 
                    {
                        ...
                        else if (data.code == 200) 
                        {
                            ...
                            $.each(data.result, function (u_key, u_value) {
                                // console.log(u_value);
                                    beat_total += parseInt(u_value.beat_count);
                                    dealer_retailer_total += parseInt(u_value.retailer_count);
                                    beat_retailer_total += (data.actual_retailer_count[u_value.dealer_id])?parseInt(data.actual_retailer_count[u_value.dealer_id]):0;
                        ...
                        success: function (data) 
                        {
                            ...
                            else if (data.code == 200) 
                            {
                                ...
                                $.each(data.result_data, function (b_key, b_value) {
                                    ...
                                    {
                                         total_retailer_count += parseInt(data.retailer_count_beat[b_value.location_id]);
   ...
   <script>
    ...
    <script>
        ...
        // for holiday
        function HolidayAction(heading, name, action_id, tab, act) {
         ...
         $.confirm({
             ...
             buttons: {
                 confirm: function () {
                     EnableHolidayAction(name, action_id, tab, act);
                     $.alert({
                         title: 'Alert!',
                         content: 'Sccessfully Done!',
                         buttons: {
     ...
     function EnableHolidayAction(module, action_id, tab, act) {
         ...
         if (action_id != '') {
             ...
             $.ajax({
                 type: "POST",
                 url: domain + '/EnableHolidayAction',
                 dataType: 'json',
                 data: {'module': module, 'action_id': action_id, 'tab': tab, 'act': act},
                 success: function (data) {
                     // console.log(data);
                            ...
                            buttons: {
                                ok: function () {
                                    ...
                                    else if(heading == 'User')
                                    {
                                        ...
                                        if(act == 'inactive')
                                        {
                                            $('#'+concat).append("<button title='active' class='btn btn-xs btn-success' onclick=confirmAction('User','User',"+action_id+",'person','active'); > <i class='ace-icon fa fa-check bigger-120'></i> </button>");
                                            $('#'+concat_status).append("<span class='label label-sm label-warning'>In-active</span>");
                                        }
                                        else if(act == 'active')
                                        {
                                            $('#'+concat).append("<button title='Inactive' class='btn btn-xs btn-warning' onclick=confirmAction('User','User',"+action_id+",'person','inactive'); > <i class='ace-icon fa fa-ban bigger-120'></i> </button>");
