            ...
            while ($p < $callwisereport) {
                ...
                if ($run_assoc_uho >= 1) {
                    ...
                    if ($num_data < 1 ) {
                        ...
                        $qusod = "INSERT INTO `user_sales_order_details1`(`order_id`, `product_id`, `rate`,`case_rate`, `quantity`, `scheme_qty`,`company_id`,`piece_quantity`,`case_quantity`,`secondary_quantity`,`secondary_rate`,`weight`,`status`)"
                        ...
                        $qusod = "UPDATE `user_sales_order_details1` SET `quantity`='$prod_qty',`rate`='$rate' WHERE order_id='$orderid$user_id' AND product_id='$product_id' AND `company_id` = '$company_id' ";
                    }
